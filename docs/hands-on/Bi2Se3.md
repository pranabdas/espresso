...
<img src={require("../../static/img/Bi2Se3-bands.webp").default} className="inv-hue-rot-180" alt="Bi2Se3-bands"/>
...
<img src={require("../../static/img/Bi2Se3-dos.webp").default} className="inv-hue-rot-180" alt="Bi2Se3-dos"/>
