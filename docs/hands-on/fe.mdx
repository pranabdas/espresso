...
<img src={require("../../static/img/fe-convergence.webp").default} className="inv-hue-rot-180" alt="fe-convergence"/>
...
<img src={require("../../static/img/fe-dos.webp").default} className="inv-hue-rot-180" alt="fe-dos"/>

<img src={require("../../static/img/fe-pdos.webp").default} className="inv-hue-rot-180" alt="fe-pdos"/>
