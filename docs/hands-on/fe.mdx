...
<CodeBlock language="bash" title="src/fe/fe_ecut.pwtk">{fe_ecut_pwtk}</CodeBlock>
...
<CodeBlock language="bash" title="src/fe/fe_dos.pwtk">{fe_dos_pwtk}</CodeBlock>
...
<CodeBlock language="bash" title="src/fe/fe.xsf">{fe_mag}</CodeBlock>
