...
<CodeBlock language="bash" title="src/al/al_vc_relax.in">{al_vc_relax_in}</CodeBlock>
...
<CodeBlock language="bash" title="src/al/al_scf.in">{al_scf_in}</CodeBlock>
...
<CodeBlock language="bash" title="src/al/al_nscf.in">{al_nscf_in}</CodeBlock>
...
<CodeBlock language="bash" title="src/al/al_dos.in">{al_dos_in}</CodeBlock>
...
<CodeBlock language="bash" title="src/al/al_bands.in">{al_bands_in}</CodeBlock>
...
<CodeBlock language="bash" title="src/al/al_bands_pp.in">{al_bands_pp_in}</CodeBlock>
