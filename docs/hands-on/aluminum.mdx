...
<img src={require("../../static/img/al-dos.webp").default} className="inv-hue-rot-180" alt="al-dos"/>
...
<img src={require("../../static/img/al-bands.webp").default} className="inv-hue-rot-180" alt="al-bands"/>
...
<img src={require("../../static/img/al-smearing.webp").default} className="inv-hue-rot-180" alt="al-smearing"/>
