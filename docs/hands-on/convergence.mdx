...
<img src={require("../../static/img/etot-vs-ecutwfc.webp").default} className="inv-hue-rot-180" alt="etot-vs-ecutwfc"/>
...
<img src={require("../../static/img/etot-vs-kpoints.webp").default} className="inv-hue-rot-180" alt="etot-vs-kpoints"/>
...
<img src={require("../../static/img/etot-vs-alat.webp").default} className="inv-hue-rot-180" alt="etot-vs-alat"/>
