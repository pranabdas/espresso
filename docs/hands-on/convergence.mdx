...
<CodeBlock className="language-bash" title="src/silicon/si_scf_ecutoff.pwtk">{si_scf_ecutoff_pwtk}</CodeBlock>
...
<CodeBlock className="language-bash" title="src/silicon/si_script.sh">{si_script_sh}</CodeBlock>
...
<CodeBlock className="language-bash" title="src/silicon/si_scf_kpoints.pwtk">{si_scf_kpoints_pwtk}</CodeBlock>
...
<CodeBlock className="language-bash" title="src/silicon/si_scf_alat.pwtk">{si_scf_alat_pwtk}</CodeBlock>
