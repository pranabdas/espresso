...
<img src={require("../../static/img/fe-soc-bands.webp").default} className="inv-hue-rot-180" alt="fe-soc-bands"/>
...
<img src={require("../../static/img/GaAs-soc-bands.webp").default} className="inv-hue-rot-180" alt="GaAs-soc-bands"/>
