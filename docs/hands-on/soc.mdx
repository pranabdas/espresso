...
<CodeBlock className="bash" title="src/fe/pw.scf.fe_soc.in">{pw_scf_fe_soc_in}</CodeBlock>
...
<CodeBlock className="bash" title="src/fe/pw.bands.fe_soc.in">{pw_bands_fe_soc_in}</CodeBlock>
...
<CodeBlock className="bash" title="src/fe/pp.bands.fe_soc.in">{pp_bands_fe_soc_in}</CodeBlock>
