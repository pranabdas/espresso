...
<CodeBlock className="bash" title="src/silicon/si_bands_scf.in">{si_bands_scf_in}</CodeBlock>
...
<CodeBlock className="bash" title="src/silicon/si_bands.in">{si_bands_in}</CodeBlock>
...
<CodeBlock className="bash" title="src/silicon/si_bands_pp.in">{si_bands_pp_in}</CodeBlock>
