...
<img src={require("../../static/img/silicon-bands.webp").default} className="inv-hue-rot-180" alt="silicon-bands"/>
...
- [See K-pat online tool](https://seekpath.materialscloud.io/)
