...
<img src={require("../../static/img/GaAs-phonon.webp").default} className="inv-hue-rot-180" alt="GaAs-phonon"/>
...
<img src={require("../../static/img/GaAs-phonon-dos.webp").default} className="inv-hue-rot-180" alt="GaAs-phonon-dos"/>
