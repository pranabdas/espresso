...
<img src={require("../../static/img/graphene-dos.webp").default} className="inv-hue-rot-180" alt="graphene-dos"/>
...
<img src={require("../../static/img/graphene-bands.webp").default} className="inv-hue-rot-180" alt="graphene-bands"/>
